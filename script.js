...
const packages = {
  "simple-elegant": {
    ...
    video: {
      src: "assets/simple-elegant-14k-video.mp4",
  ...
  "on-the-go": {
    ...
    video: {
      src: "assets/on-the-go-18k-video.mp4",
  ...
  flashmob: {
    ...
    video: {
      src: "assets/flashmob-26k-video.mp4",
  ...
  emotions: {
    ...
    video: {
      src: "assets/emotions-28k-video.mp4",
  ...
  "unique-wow": {
    ...
    video: {
      src: "assets/unique-wow-video.mp4",
  ...
  "car-surprise": {
    ...
    image: {
      src: "assets/car-surprise-photo-01.jpeg",
      alt: "Car Surprise birthday trunk setup with balloons, bouquet and lights",
    },
    video: {
      src: "assets/car-surprise-video.mp4",
  ...
  boat: {
    ...
    video: {
      src: "assets/private-solo-boat-video.mp4",
...
const cakes = Object.fromEntries(
  Array.from({ length: 21 }, (_, index) => {
    ...
    return [
      ...
      {
        name: `Cake ${number}`,
        image: `assets/cakes/cake-${number}.jpg`,
      },
    ];
  })
);
...
Please send me more details.`;
  ...
  window.open(`https://wa.me/94720626224?text=${encodeURIComponent(message)}`, "_blank");
};

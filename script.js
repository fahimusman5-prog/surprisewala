...
const navbarCountries = [
  { name: "Sri Lanka", flag: "https://flagcdn.com/w40/lk.png", whatsapp: "94760505866" },
  { name: "United Arab Emirates", flag: "https://flagcdn.com/w40/ae.png", whatsapp: "94760505866" },
  { name: "Qatar", flag: "https://flagcdn.com/w40/qa.png", whatsapp: "94760505866" },
  { name: "Saudi Arabia", flag: "https://flagcdn.com/w40/sa.png", whatsapp: "94760505866" },
  { name: "Kuwait", flag: "https://flagcdn.com/w40/kw.png", whatsapp: "94760505866" },
  { name: "Oman", flag: "https://flagcdn.com/w40/om.png", whatsapp: "94760505866" },
  { name: "Japan", flag: "https://flagcdn.com/w40/jp.png", whatsapp: "94760505866" },
  { name: "Australia", flag: "https://flagcdn.com/w40/au.png", whatsapp: "94760505866" },
  { name: "United Kingdom", flag: "https://flagcdn.com/w40/gb.png", whatsapp: "94760505866" },
];
...
const renderCustomerSummary = () => {
  ...
  const dateTime = [details.date, details.time].filter(Boolean).join(" ");
  ...
  customerSummary.innerHTML = `
    <dl>
      ...
      <div><dt>Date & Time</dt><dd>${dateTime || details.date}</dd></div>
...
const confirmCheckoutOnWhatsapp = () => {
  ...
  const bankNote =
    selectedPaymentMethod === "bank"
      ? "\nBank transfer selected. I will send the payment slip after transferring."
      : "";
...
Preferred Time: ${details.time || "Not provided"}

Order Details:
Selected Packages:
${getCartItemsText()}

Total: ${formatCurrency(breakdown.originalTotal)}
Payment Method: ${breakdown.method.name}
Extra Fee: ${formatCurrency(breakdown.feeAmount)}
Final Payable Amount: ${formatCurrency(breakdown.finalTotal)}

Notes:
${details.notes || "No notes provided"}${bankNote}`;
...
if (checkoutForm) {
  checkoutForm.addEventListener("submit", (event) => {
    ...
    if (missingFields.length) {
      if (checkoutError) {
        checkoutError.textContent = "Please complete the required fields.";
      }
      return;
    }
    ...
    .map(
      (country, index) => `
        <button class="country-option" type="button" data-navbar-country="${index}">
          <span class="country-option__flag" aria-hidden="true">
